...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [129 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12961888; uint32_t buffer_offset
	}, ; 127: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2108416, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12983424; uint32_t buffer_offset
	} ; 128: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15091840, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15091840 x i8] zeroinitializer, align 1
